...
def get_args():
    ...
    parser.add_argument('--ff_size', type=int, default=1088
                        ,
                        help='hidden size in projection network')
    ...
    parser.add_argument('--layerforsemantic', type=int, default=2)
    ...
    # Training Setting
    parser.add_argument('--batch_size', type=int, default=210, metavar='N',
