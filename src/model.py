...
from transformer import Block_fusion,Block_fusion0,make_mask,MHAtt,Block_gf,Block_split0,Block_split,filter,reconenc,Block_trans,Block_gff,selector
...
class MMIM(nn.Module):
    ...
    def forward(self, sentences, visual, acoustic, v_len, a_len, bert_sent, bert_sent_type, bert_sent_mask, y=None, mem=None):
        ...
        x1=self.att(x, x, y,None)
        y1 = y
        z1 = self.att(z, z, y,None)
        x=x+x1
        y=y+y1
        z=z+z1
...
###############abaltion x zhudao
        ...
        return preds,ixy,iyz,izx,iy,x_c,y_c,z_c,fusion,preds1,x_pre,y_pre,z_pre,x_dif,y_dif,z_dif,x,y,z,x_sin,y_sin,z_sin
