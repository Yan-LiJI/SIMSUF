    ...
    def train_and_eval(self):
        ...
        def train(model, optimizer, criterion, stage=1):
            ...
            for i_batch, batch_data in enumerate(self.train_loader):
                ...
                preds,ixy,iyz,izx,pre4,x_shared,y_shared,z_shared,fusion,preds1,x_pre,y_pre,z_pre,x_dif,y_dif,z_dif,xre,yre,zre,x_sin,y_sin,z_sin = model(text, visual, audio, vlens, alens,
        ...
        def evaluate(model, criterion, test=False):
            ...
            with torch.no_grad():
                ...
                for batch in loader:
                    ...
                    preds, pre1, pre2, pre3, pre4,x_shared,y_shared,z_shared,fusion,preds1,x_pre,y_pre,z_pre,x_dif,y_dif,z_dif,xre,yre,zre,xsin,ysin,zsin = model(text, vision, audio, vlens, alens,
                                                          bert_sent, bert_sent_type, bert_sent_mask, y)
